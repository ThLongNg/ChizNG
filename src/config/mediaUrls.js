// Cloud URLs for media assets
// Replace these URLs with your cloud storage URLs after uploading
...
export const MEDIA_URLS = {
  ...
  cyrenePng: '/assets/cyrene.png',
  
  // Music Playlist - Replace with cloud URLs
  songs: [
    {
    ...
    {
      name: "Hope Is The Thing With Feathers - Honkai Star Rail",
